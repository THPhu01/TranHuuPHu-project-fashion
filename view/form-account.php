			...
			<div class="row">
				<div class="col-md-12 p-b-50">
					<div class="p-r-15 p-rl-0-lg">
						...
						<form method="post" action="?ctrl=account.php&act=login" class="how-bor3 p-rl-30 p-tb-32">
							<div class="p-b-24">
								<div class="txt-s-101 cl6 p-b-10">
									Tên tài khoản <span class="cl12">*</span>
								</div>

								<input class="txt-s-120 cl3 size-a-21 bo-all-1 bocl15 p-rl-15 focus1" type="text" name="username" required>
							</div>
							...
							<div class="flex-w flex-m p-t-15 p-b-10">
								<input type="submit" name="submit" class="flex-c-m txt-s-105 cl0 bg10 size-a-39 hov-btn2 trans-04 p-rl-10 m-r-18" value="Đăng nhập">
							...
							<br>
							<a href="?act=showRegister" class="txt-s-101 cl9 hov-cl10 trans-04">
								Chưa có tài khoản ?
							</a>
						</form>
					</div>
