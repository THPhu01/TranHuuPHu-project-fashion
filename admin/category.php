        ...
        <div id="inner-container">
            ...
            <div id="page-content">
                ...
                <ul id="nav-info" class="clearfix">
                    ...
                    <li class="active"><a href="">QUẢN LÝ LOẠI</a></li>
                </ul>
                <h1>QUẢN LÝ LOẠI</h1>
                <hr>
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="hidden-xs hidden-sm">TÊN LOẠI</th>
                    ...
                    <tbody>
                        ...
                        foreach ($result as $r) {
                            echo '<tr>
                                            ...
                                            <td class="text-center">' . $r['idCategory'] . '</td>
                                            <td class="hidden-xs hidden-sm">' . $r['nameCategory'] . '</td>
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="?ctrl=admin.php&act=showEditCate&id=' . $r['idCategory'] . '" data-toggle="tooltip" title="Edit" class="btn btn-xs btn-success"><i class="fa fa-pencil"></i></a>
                                                    <a href="?ctrl=admin.php&act=deleteCate&id=' . $r['idCategory'] . '" data-toggle="tooltip" title="Delete" onclick="return confirm(`Bạn có muốn xóa không?`)" class="btn btn-xs btn-danger"><i class="fa fa-times"></i></a>
                                                </div>
                                            </td>
                                        </tr>';
                        }
