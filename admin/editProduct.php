...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="../admin/css-admin/bootstrap.css">

        <!-- Related styles of various javascript plugins -->
        <link rel="stylesheet" href="../admin/css-admin/plugins.css">
        ...
        <link rel="stylesheet" href="../admin/css-admin/themes.css">
        <!-- END Stylesheets -->
            ...
            <div id="inner-container">
                ...
                <aside id="page-sidebar" class="collapse navbar-collapse navbar-main-collapse">
                    ...
                    <nav id="primary-nav">
                        <ul>
                            <li>
                                <a href="?ctrl=admin.php&act=index"><i class="fa fa-fire"></i>Dashboard</a>
                            </li>
                            <li>
                                <a href="#"><i class="fa fa-th-list"></i>QUẢN LÝ SẢN PHẨM</a>
                                <ul>
                                    <li>
                                        <a href="?ctrl=admin.php&act=listProduct" class="active"><i class="fa fa-file-text"></i>Danh sách sản phẩm</a>
                                    </li>
                                    <li>
                                        <a href="?ctrl=admin.php&act=addProduct"><i class="fa fa-exclamation-triangle"></i>Thêm sản phẩm</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                <a href="#"><i class="fa fa-th-list"></i>QUẢN LÝ LOẠI</a>
                                <ul>
                                    <li>
                                        <a href="?ctrl=admin.php&act=listCate"><i class="fa fa-file-text"></i>Danh sách loại</a>
                                    </li>
                                    <li>
                                        <a href="?ctrl=admin.php&act=addCate"><i class="fa fa-exclamation-triangle"></i>Thêm loại</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                <a href="#"><i class="fa fa-th-list"></i>QUẢN LÝ KHÁCH HÀNG</a>
                                <ul>
                                    <li>
                                        <a href="?ctrl=admin.php&act=listUser"><i class="fa fa-file-text"></i>Danh sách khách hàng</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                ...
                <div id="page-content">
                    ...
                    <h1>SỬA SẢN PHẨM</h1>
                    <hr>
                    <form action="?ctrl=admin.php&act=editProduct" method="post" class="form-horizontal form-box">
                        <?php
                            if(isset($_GET['id'])){
                                $id = $_GET['id'];
                                $pro = new product();
                        ...
                        ?>
                        <h4 class="form-box-header"></h4>
                        <div class="form-box-content">
                            <!-- Input Sizes -->
                            <div class="form-group">
                                <label class="control-label col-md-2" for="example-input-normal">Mã sản phẩm : </label>
                                <div class="col-md-3">
                                <input type="text" id="example-input-normal" name="idPro" class="form-control" readonly value="<?php echo $result['idProduct']?>">
                                </div>
                                <div class="col-md-7">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <input type="text" id="example-input-normal" name="name" class="form-control" value="<?php echo $result['nameProduct']?>">
                                </div>
                                <div class="col-md-7">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-2" for="example-input-normal">Giá cũ</label>
                                <div class="col-md-3">
                                    <input type="text" id="example-input-normal" name="oldPrice" class="form-control" value="<?php echo $result['oldPrice']?>">
                                </div>
                                <div class="col-md-7">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-2" for="example-input-normal">Giá mới</label>
                                <div class="col-md-3">
                                    <input type="text" id="example-input-normal" name="newPrice" class="form-control" value="<?php echo $result['newPrice']?>">
                                </div>
                                <div class="col-md-7">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-2" for="example-input-normal">Số lượng</label>
                                <div class="col-md-3">
                                    <input type="text" id="example-input-normal" name="quantity" class="form-control" value="<?php echo $result['quantity']?>">
                                </div>
                                <div class="col-md-7">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-2" for="example-textarea">Mô tả</label>
                                <div class="col-md-4">
                                    <textarea id="example-textarea" name="description" class="form-control" rows="3"><?php echo $result['description']?></textarea>
                                </div>
                            </div>
                            <div class="form-group form-actions">
                                <div class="col-md-10 col-md-offset-2">
                                    <input type="submit" name="save" class="btn btn-success" value="Lưu">
                                    <input type="submit" name="cancel" class="btn btn-danger" value="Hủy">
                                </div>
                            </div>
                    </form>
                </div>
