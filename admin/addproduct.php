        ...
        <div id="page-container">
            ...
            <div id="inner-container">
                ...
                <div id="page-content">
                    ...
                    <h1>THÊM SẢN PHẨM</h1>
                    <hr>
                    <form action="?ctrl=admin.php&act=addPro" method="post" class="form-horizontal form-box" enctype="multipart/form-data">
                        ...
                        <div class="form-box-content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <input type="text" id="example-input-normal" name="name" class="form-control" required>
                                </div>
                                <div class="col-md-7">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-2" for="example-input-normal">Giá sản phẩm</label>
                                <div class="col-md-3">
                                    <input type="text" id="example-input-normal" name="price" class="form-control" required>
                                </div>
                                <div class="col-md-7">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <input type="text" id="example-input-normal" name="quantity" class="form-control">
                                </div>
                                <div class="col-md-7">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-2" for="example-input-normal">Thương hiệu</label>
                                <div class="col-md-3">
                                    <select id="example-select" name="brand" class="form-control">
                                        <option value="1">Adidas</option>
                                        <option value="2">Nike</option>
                                        <option value="3">Coolmate</option>
                                        <option value="4">Puma</option>
                                        <option value="5">Delta Sport</option>
                                    </select>
                                </div>
                                <div class="col-md-7">
                                </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-2" for="example-input-normal">Loại sản phẩm</label>
                                <div class="col-md-3">
                                    <select id="example-select" name="cate" class="form-control">
                                        ...
                                        <option value="7">Giày</option>
                                        <option value="8">Thắt Lưng</option>
                                        <option value="9">Kính Râm</option>
                                        <option value="10">Kính Mát</option>
                                    </select>
                                </div>
                                <div class="col-md-7">
                                </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-2" for="example-input-normal">Ảnh</label>
                                <div class="col-md-3">
                                    <input type="file" id="example-input-normal" name="img" class="form-control">
                                </div>
                                <div class="col-md-7">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <textarea id="example-textarea" name="description" class="form-control" rows="3" required></textarea>
                                </div>
                            </div>
