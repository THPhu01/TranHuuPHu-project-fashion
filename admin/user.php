                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="hidden-xs hidden-sm">TÊN KHÁCH HÀNG</th>
                                <th class="hidden-xs hidden-sm">ĐỊA CHỈ</th>
                                <th class="hidden-xs hidden-sm">SỐ ĐIỆN THOẠI</th>
                                <th class="hidden-xs hidden-sm">EMAIL</th>
                                <th class="hidden-xs hidden-sm">PHÂN QUYỀN</th>
                                <th class="cell-small text-center"><i class="fa fa-bolt"></i>SỬA</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                                ...
                                foreach($resultUser as $rUser){
                                    $resultRole = $role->getRoleById($rUser['role']);
                                    echo '<tr>
                                            <td class="text-center"><input type="checkbox" id="check3-td1" name="check3-td1"></td>
                                            <td class="text-center">'.$rUser['idUser'].'</td>
                                            <td><a href="javascript:void(0)">'.$rUser['nameUser'].'</a></td>
                                            <td class="hidden-xs hidden-sm">'.$rUser['address'].'</td>
                                            <td class="hidden-xs hidden-sm">'.$rUser['phone'].'</td>
                                            <td class="hidden-xs hidden-sm">'.$rUser['email'].'</td>
                                            <td class="hidden-xs hidden-sm">'.$resultRole['nameRole'].'</td>
