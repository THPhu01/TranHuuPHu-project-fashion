    ...
    <div id="page-container">
        ...
        <div id="inner-container">
            ...
            <div id="page-content">
                ...
                <hr>
                <form action="?ctrl=admin.php&act=editCate" method="post" class="form-horizontal form-box">
                    ...
                    <div class="form-box-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="text" id="example-input-normal" name="idCate" class="form-control" readonly value="<?php echo $result['idCategory'] ?>">
                            </div>
                            <div class="col-md-7">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-2" for="example-input-normal">Tên loại sản phẩm</label>
                            <div class="col-md-3">
                                <input type="text" id="example-input-normal" name="name" class="form-control" value="<?php echo $result['nameCategory'] ?>">
                            </div>
                            <div class="col-md-7">
                            </div>
                        </div>
