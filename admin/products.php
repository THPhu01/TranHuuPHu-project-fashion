                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="hidden-xs hidden-sm">LOẠI SẢN PHẨM</th>
                            <th class="hidden-xs hidden-sm">THƯƠNG HIỆU</th>
                            <th class="hidden-xs hidden-sm">GIÁ CŨ</th>
                            <th class="hidden-xs hidden-sm">GIÁ MỚI</th>
                            <th class="cell-small">SỐ LƯỢNG</th>
                            <th class="hidden-xs hidden-sm">MÔ TẢ</th>
                            <th class="cell-small text-center"><i class="fa fa-bolt"></i>XÓA/SỬA</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        $resultPro = $pro->getProduct();
                        foreach ($resultPro as $rPro) {
                            $resultCate = $cate->getCategoryById($rPro['idCategory']);
                            $resultBrand = $bra->getBrandById($rPro['idBrand']);
                            echo '<tr>
                                            <td class="text-center"><input type="checkbox" id="check3-td1" name="check3-td1"></td>
                                            <td class="text-center">' . $rPro['idProduct'] . '</td>
                                            <td><img src="img' . $rPro['imgURL'] . '" width=90 height=90></td>
                                            <td class="hidden-xs hidden-sm">' . $rPro['nameProduct'] . '</td>
                                            <td class="hidden-xs hidden-sm">
                                                ' . $resultCate['nameCategory'] . '
                                            </td>
                                            <td class="hidden-xs hidden-sm">
                                                ' . $resultBrand['nameBrand'] . '
                                            </td>
                                            <td class="hidden-xs hidden-sm">' . $rPro['oldPrice'] . '</td>
                                            <td class="hidden-xs hidden-sm">' . $rPro['newPrice'] . '</td>
                                            <td class="hidden-xs hidden-sm">' . $rPro['quantity'] . '</td>
                                            <td class="hidden-xs hidden-sm">' . $rPro['description'] . '</td>
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="?ctrl=admin.php&act=showEditPro&id=' . $rPro['idProduct'] . '" data-toggle="tooltip" title="Edit" class="btn btn-xs btn-success"><i class="fa fa-pencil"></i></a>
                                                    <a href="?ctrl=admin.php&act=deleteProduct&id=' . $rPro['idProduct'] . '" data-toggle="tooltip" title="Delete" onclick="return confirm(`Bạn có muốn xóa không?`)" class="btn btn-xs btn-danger"><i class="fa fa-times"></i></a>
                                                </div>
                                            </td>
                                        </tr>';
                        }
